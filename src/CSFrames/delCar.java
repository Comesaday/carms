...
public class delCar extends JInternalFrame implements ActionListener,ListSelectionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final String CSFrames = null;
	private static final Frame delCar = null;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==button1) {
			FileDialog fd=new FileDialog(delCar,"保存记录",FileDialog.SAVE);
			...
			bean.delThisCar(cids);
			this.dispose();
			
			delCar delcar=new delCar();
			carMain.desktopPane.add(delcar);
		}
